...
declare global {
  ...
  const VueQueryPluginOptions: typeof import('@tanstack/vue-query')['VueQueryPluginOptions']
  ...
  const defineMiddleware: typeof import('astro')['defineMiddleware']
  ...
  const redirect: typeof import('astro')['redirect']
